               ...
               <header className="px-2 py-3">
                    <div className="flex justify-between items-center gap-4 max-w-7xl mx-auto">
                         ...
                         <div className="flex gap-4 items-center">
                              ...
                              <Link to="/services" className="uppercase font-medium text-sm border-b-2 border-transparent transition-colors duration-300 hover:border-customTheme-theme1">Services</Link>
                              <Link to="/products" className="uppercase font-medium text-sm border-b-2 border-transparent transition-colors duration-300 hover:border-customTheme-theme1">Products</Link>
                              <Link to="/intraday-calls" className="uppercase font-medium text-sm border-b-2 border-transparent transition-colors duration-300 hover:border-customTheme-theme1">Intraday Calls</Link>
